...
namespace TankGame.Src.Actors.GameObjects
{
    internal static class GameObjectType
    {
        ...
        public static readonly Tuple<TraversibilityData, DestructabilityData, string> Gruz = new Tuple<TraversibilityData, DestructabilityData, string> (new TraversibilityData(1.25F, true), new DestructabilityData(1, false, false), null);
        ...
        public static readonly Tuple<TraversibilityData, DestructabilityData, string> Pien = new Tuple<TraversibilityData, DestructabilityData, string> (new TraversibilityData(1.25F, true), new DestructabilityData(1, false, false), null);
