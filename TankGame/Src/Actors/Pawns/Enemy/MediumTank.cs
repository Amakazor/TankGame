...
namespace TankGame.Src.Actors.Pawns.Enemies
{
    ...
    {
        public MediumTank(Vector2f position, Vector2f size, int health = 2) : base(position, size, TextureManager.Instance.GetTexture(TextureType.Pawn, "enemy2"), health, 200)
        {
        }
