...
public class Stump : GameObject {
    ...
    private static readonly Texture Tex = TextureManager.Get(TextureType.GameObject, "Stump");
    public Stump(Vector2i coords) : base(coords, Tex) { }
    public Stump(Dto dto, Vector2i coords) : base(dto, Tex, coords) { }
