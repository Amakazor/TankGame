...
public class DeciduousTree : GameObject {
    public new class Dto : GameObject.Dto { }
    
    private static readonly Texture Tex = TextureManager.Get(TextureType.GameObject, "TreeDeciduous");
    public DeciduousTree(Vector2i coords) : base(coords, Tex, 4) { }
    public DeciduousTree(Dto dto, Vector2i coords) : base(dto, Tex, coords) { }
