...
public class DestroyedTower : GameObject {
    public new class Dto : GameObject.Dto { }
    
    private static readonly Texture Tex = TextureManager.Get(TextureType.GameObject, "towercompleted");
    public DestroyedTower(Vector2i coords) : base(coords, Tex) { }
    public DestroyedTower(Dto dto, Vector2i coords) : base(dto, Tex, coords) { }
